...
public class FRevoluteJoint extends FJoint {
  ...
  protected void updateLocalAnchors() {
    m_localAnchor1 = m_body1.getLocalWorldPoint(new Vec2(getAnchorX(), getAnchorY())); //hAPI_Fisica.screenToWorld(getAnchorX() - m_body1.getX(), getAnchorY() - m_body1.getY());
    m_localAnchor2 = m_body2.getLocalWorldPoint(new Vec2(getAnchorX(), getAnchorY())); //hAPI_Fisica.screenToWorld(getAnchorX() - m_body2.getX(), getAnchorY() - m_body2.getY());
  }
  ...
  public void setAnchor(float x, float y) {
    if (m_joint != null) {
      ((RevoluteJoint)m_joint).getAnchor2().set((x), (y));
    }
  ...
  public void draw(PGraphics applet){
    ...
    applet.ellipse(hAPI_Fisica.worldToScreen(getAnchorX()), hAPI_Fisica.worldToScreen(getAnchorY()), 10, 10);
