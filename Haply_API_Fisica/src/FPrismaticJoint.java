...
public class FPrismaticJoint extends FJoint {
  ...
  public FPrismaticJoint(FBody body1, FBody body2) {
    ...
    m_anchor = new Vec2(body2.getX(), body2.getY());
    updateLocalAnchors();
  ...
  public void setAxis(float x, float y) {
    ...
    float d = hAPI_Fisica.parent().dist(0, 0, x, y);
    m_axis = new Vec2(x/d, y/d);
    updateLocalAxis();
  }
   ...
   *
   * @param translation  lowest translation position in simulation world units
   */
  public void setLowerTranslation(float translation) {
    if (m_joint != null) {
      ((PrismaticJoint)m_joint).m_lowerTranslation = (translation);
    }
   ...
   *
   * @param translation  highest translation position in simulation world units
   */
  public void setUpperTranslation(float translation) {
    if (m_joint != null) {
      ((PrismaticJoint)m_joint).m_upperTranslation = (translation);
    }
  ...
  public void draw(PGraphics applet){
    ...
    applet.line(hAPI_Fisica.worldToScreen(getAnchorX()), hAPI_Fisica.worldToScreen(getAnchorY()), hAPI_Fisica.worldToScreen(getBody1().getX()), hAPI_Fisica.worldToScreen(getBody1().getY()));
    applet.line(hAPI_Fisica.worldToScreen(getAnchorX()), hAPI_Fisica.worldToScreen(getAnchorY()), hAPI_Fisica.worldToScreen(getBody2().getX()), hAPI_Fisica.worldToScreen(getBody2().getY()));
    applet.rect(hAPI_Fisica.worldToScreen(getAnchorX()), hAPI_Fisica.worldToScreen(getAnchorY()), 10, 10);
  ...
  public void drawDebug(PGraphics applet){
    ...
    applet.translate(hAPI_Fisica.worldToScreen(getBody1().getX()), hAPI_Fisica.worldToScreen(getBody1().getY()));
    applet.rotate(getBody1().getRotation());
    //applet.translate(-getBody1().getX(), -getBody1().getY());
    
    applet.translate(hAPI_Fisica.worldToScreen(m_localAnchor1).x, hAPI_Fisica.worldToScreen(m_localAnchor1).y);
    applet.translate(-hAPI_Fisica.worldToScreen(m_localAnchor2).x, -hAPI_Fisica.worldToScreen(m_localAnchor2).y);
    applet.rotate(hAPI_Fisica.parent().atan2(m_axis.y, m_axis.x));
    ...
    if (m_enableLimit) {
        ...
        applet.rect(hAPI_Fisica.worldToScreen(m_lowerTranslation), -4, hAPI_Fisica.worldToScreen(m_upperTranslation), 4);
    }
    ...
    applet.pushStyle();
    applet.noStroke();
    applet.ellipse(hAPI_Fisica.worldToScreen(getAnchorX()), hAPI_Fisica.worldToScreen(getAnchorY()), 5, 5);
    applet.ellipse(hAPI_Fisica.worldToScreen(getBody1().getX()), hAPI_Fisica.worldToScreen(getBody1().getY()), 5, 5);
    applet.ellipse(hAPI_Fisica.worldToScreen(getBody2().getX()), hAPI_Fisica.worldToScreen(getBody2().getY()), 5, 5);
    applet.popStyle();
