...
public class FMouseJoint extends FJoint {
  ...
  public void setTarget(float x, float y) {
    if (m_joint != null) {
      ((MouseJoint)m_joint).setTarget(new Vec2(x, y));
    }
  ...
  public float getTargetX(){
    if (m_joint != null) {
      return (((MouseJoint)m_joint).m_target).x;
    }
  ...
  public float getTargetY(){
    if (m_joint != null) {
      return (((MouseJoint)m_joint).m_target).y;
    }
  ...
  public void setGrabbedBodyAndTarget(FBody body, float x, float y) {
    if (m_joint != null) {
      ...
      ((MouseJoint)m_joint).m_target.set(new Vec2(x, y));
      ((MouseJoint)m_joint).getAnchor2().set((x),(y));
    }
  ...
  public void draw(PGraphics applet){
    ...
    applet.line(hAPI_Fisica.worldToScreen(getAnchorX()), hAPI_Fisica.worldToScreen(getAnchorY()), hAPI_Fisica.worldToScreen(getTargetX()), hAPI_Fisica.worldToScreen(getTargetY()));
  ...
  public void drawDebug(PGraphics applet){
    ...
    applet.ellipse(hAPI_Fisica.worldToScreen(getTargetX()), hAPI_Fisica.worldToScreen(getTargetY()), 10, 10);
