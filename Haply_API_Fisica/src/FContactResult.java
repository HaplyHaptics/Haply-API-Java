...
public class FContactResult {
   ...
   *
   * @return the horizontal position of the contact point in simulation world units
   * @see #getY
   */
  public float getX() {
    return (m_position).x;
   ...
   *
   * @return the vertical position of the contact point in simulation world units
   * @see #getX
   */
  public float getY() {
    return (m_position).y;
